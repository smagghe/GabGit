...
#define DEFAULT_NAME        "GabDevice"         // Enter your device friendly name
#define DEFAULT_SSID        "xx"              // Enter your network SSID
#define DEFAULT_KEY         "xx"            // Enter your network WPA key
#define DEFAULT_SERVER      "192.168.0.xxx"       // Enter your Domoticz Server IP address
